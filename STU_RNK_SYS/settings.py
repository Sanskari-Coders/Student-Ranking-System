"""
Django settings for STU_RNK_SYS project.
...
SECRET_KEY = 'django-insecure-n0&o@ce79xb-7je)^0j^!#8@3pzid^la@0mardzs@cspgtqv9f'
...
WSGI_APPLICATION = 'STU_RNK_SYS.wsgi.application'
